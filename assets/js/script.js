...
(function () {
  ...
  const POSITIONS = [
    'Physics Teacher – Cambridge A Level',
  'Biology Teacher – Cambridge A Level',
  'Psychology Teacher – Cambridge A Level',
  'Business Studies Teacher – Cambridge A Level',
  'Economics Teacher – Cambridge A Level',
  'Mathematics Teacher – Cambridge A Level',
  'English Teacher – Cambridge A Level',
  'Chemistry Teacher – CAIE Secondary',
  'Art & Design Teacher – CAIE Secondary',
...
const JD_MAP = {
  'Art & Design Teacher – CAIE Secondary': '/assets/jd/Job%20Description-Art.docx',
  'Physics Teacher – Cambridge A Level': '/assets/jd/Job%20Description-Physics.docx',
  'Biology Teacher – Cambridge A Level': '/assets/jd/Job%20Description-Biology.docx',
  'Psychology Teacher – Cambridge A Level': '/assets/jd/Job%20Description-Psychology.docx',
  'Business Studies Teacher – Cambridge A Level': '/assets/jd/Job%20Description-Bus%20studies.docx',
  'Economics Teacher – Cambridge A Level': '/assets/jd/Job%20Description-Economics.docx',
  'English Teacher – Cambridge A Level': '/assets/jd/Job%20Description-English.docx',
  'Chemistry Teacher – CAIE Secondary': '/assets/jd/Job%20Description-Chemistry-caie.docx',
  'Mathematics Teacher – Cambridge A Level': '/assets/jd/Job%20Description-Maths.docx'
};
  ...
  function openApplyModal() {
    ...
    form.addEventListener('submit', async function (ev) {
      ...
      try {
        ...
        const okMsg = (json && json.message)
          ? json.message
          : 'Application received —Check your downloaded Job Description.';
