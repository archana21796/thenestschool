...
$stmt = $db->prepare(
    "INSERT INTO ns_enquire_admission (name, mobile, email, resource, experience, message, btncta, ip, source, page_url, posted_date)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
);
...
$stmt->bind_param(
    "sssssssssss",
    $sender_name, $sender_mobile, $email, $resource, $experience, $message, $btncta, $ip, $source,  $page_url,  $date
);
