...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-45X0ZNP0YX"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'G-45X0ZNP0YX');
    </script>
    ...
    })(window,document,'script','dataLayer','GTM-5VXZL7JJ');</script>
    <!-- End Google Tag Manager -->
    
    <title>IB Primary School (Grades 1-5)</title>
    <meta charset="utf-8">
    <meta name="title" content="IB Primary School (Grades 1-5)">
    <meta name="Description" content="Inquiry-Based Learning Chennai">
    ...
    fbq('init', '2128085468017586');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=2128085468017586&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5VXZL7JJ"
    ...
    <section class="hero">
        <div class="hero__container">
            ...
            <div class="hero__content">
              ...
              <h3 class="subtitle">Building Foundations for Future Leaders</h3>
            
              <p class="programs">IB Primary Years Programme (PYP)</p>
            
              <p class="admission">
                Admissions Open for Grades 1to 5
              </p>
    ...
    <section class="iim-banner-sec">
        <div class="desktop-banner">
            <a href="#" data-toggle="modal" data-target="#enquiry-for-admission"  data-button="banner" id="enquiry-for-admission-id" class="cta-item track-btn"><img loading="lazy" decoding="async" src="../assets/images/ib-primary-school-bnr-new.webp" alt="nest-banner"></a>
        </div>
      
        <div class="mobile-banner">
            <img loading="lazy" decoding="async" src="../assets/images/ib-primary-school-mbnr.webp" alt="nest-banner">
        </div>
          <div style="display:none">
            <h1>Admissions Open for Grades 1 to 5. IB PYP framework with Robotics, Aerobay, and Makerspace labs. 2 Teachers per class for personalized attention.</h1>
            <h2>IB Primary Years Programme (PYP) – Grades 1 to 5</h2>
        </div>
    </section>-->
        ...
        <div class="grades-filter" >
            <div class="grades_filter_container">
                ...
                <ul class="grades_filter_menu" style="display: none;">
                    ...
                    <li data-grade-year="grade1-5" class="active"><span class="std">Grades 1-5</span><span class="split"> | </span><span class="abbr">IB PYP</span></li>
             ...
             <div class="alumni-wrapper right">
                ...
                <div class="mobile-testi-btm-adjmt">
                 <div id="video-slider" class="owl-carousel owl-theme alumni-left-carousel logo-slider nest-event-slider testi-arrow">
                    <div class="event-image">
                      <a href="#lightbox" class="lightbox-toggle yt-thumb yt-popup" data-lightbox-type="video" data-lightbox-content="https://www.youtube.com/embed/hD8f3kS5W7M" rel="rel1">
                        <img src="../assets/images/gallery/NEST_PYP_Web_Thumbnail.webp" alt="YouTube Short">
