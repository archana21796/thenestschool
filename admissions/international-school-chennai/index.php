...
<head>
    ...
    <title>The NEST School Chennai</title>
    <meta charset="utf-8">
    <meta name="title" content="The NEST School Chennai">
    <meta name="Description" content="Top International School in Kodambakkam">
...
<body>
    ...
    <section class="hero">
        <div class="hero__container">
            ...
            <div class="hero__content">
              ...
              <h3 class="subtitle">Balancing Curiosity with Learning</h3>
            
              <p class="programs"></p>
              <ul class="grade-list">
                <li><strong>IB EYP</strong> (Pre-KG to UKG)</li>
                <li><strong>IB PYP</strong> (Grades 1–5)</li>
                <li><strong>Cambridge LS</strong> (Grades 6–8)</li>
                <li><strong>IGCSE</strong> (Grades 9–10)</li>
                <li><strong>IBDP / AS &amp; A Levels</strong> (Grades 11–12)</li>
              </ul>
            
              <p class="admission d-none">
                Admissions Open from Pre-KG to Grade 12
              </p>
    ...
    <section class="iim-banner-sec">
        <div class="desktop-banner">
            <a href="#" data-toggle="modal" data-target="#enquiry-for-admission"  data-button="banner" id="enquiry-for-admission-id" class="cta-item track-btn"><img loading="lazy" decoding="async" src="../assets/images/international-school-chennai-bnr-new.webp" alt="nest-banner"></a>
        </div>
      
        <div class="mobile-banner">
            <img loading="lazy" decoding="async" src="../assets/images/international-school-chennai-mbnr-new.webp" alt="nest-banner">
        </div>
        
        <div style="display:none">
            <h1>Admissions Open 2025-26. A 15-Acre green campus offering IB & Cambridge curriculums. Experience hyper-personalized learning. Apply Now.</h1>
            <h2>The NEST School – Architects of Future Leaders</h2>
        </div>
    </section>
     -->
