...
<head>
     <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-251QSR6LVS"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'G-251QSR6LVS');
    </script>
    ...
    })(window,document,'script','dataLayer','GTM-KWNQNL2N');</script>
    <!-- End Google Tag Manager -->
    
    <title>Cambridge School Chennai</title>
    <meta charset="utf-8">
    <meta name="title" content="Cambridge School Chennai">
    <meta name="Description" content="Grades 6-8 Admissions">
    ...
    fbq('init', '909421214992058');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=909421214992058&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KWNQNL2N"
    ...
    <section class="hero">
        <div class="hero__container">
            ...
            <div class="hero__content">
              ...
              <h3 class="subtitle">Moving Beyond Rote Learning</h3>
            
              <p class="programs">Cambridge Lower Secondary</p>
            
              <p class="admission">
                Admissions Open for Grades 6, 7 & 8
              </p>
    ...
    <section class="iim-banner-sec">
        <div class="desktop-banner">
            <a href="#" data-toggle="modal" data-target="#enquiry-for-admission"  data-button="banner" id="enquiry-for-admission-id" class="cta-item track-btn"><img loading="lazy" decoding="async" src="../assets/images/cambridge-admission-bnr-new.webp" alt="nest-banner"></a>
        </div>
      
        <div class="mobile-banner">
            <img loading="lazy" decoding="async" src="../assets/images/cambridge-admission-mbnr.webp" alt="nest-banner">
        </div>
        
          <div style="display:none">
            <h1>Enroll for Cambridge Lower Secondary (6-8). Focus on Entrepreneurship, Internships, and Innovation. 100+ Labs on campus.</h1>
            <h2>Cambridge Lower Secondary School</h2>
        </div>
    </section>-->
        ...
        <div class="grades-filter" >
            <div class="grades_filter_container">
                ...
                <ul class="grades_filter_menu" style="display: none;">
                    ...
                    <li data-grade-year="grade6-8" class="active"><span class="std">Grades 6-8</span><span class="split"> | </span><span class="abbr">Cambridge LS</span></li>
            ...
            <div class="alumni-wrapper right">
                ...
                <div class="mobile-testi-btm-adjmt">
                 <div id="video-slider" class="owl-carousel owl-theme alumni-left-carousel logo-slider nest-event-slider testi-arrow">
                    <div class="event-image">
                      <a href="#lightbox" class="lightbox-toggle yt-thumb yt-popup" data-lightbox-type="video" data-lightbox-content="https://www.youtube.com/embed/H8YmhZp70Lc" rel="rel1">
                        <img src="../assets/images/gallery/NEST_Cambridge_Web_Thumbnail.webp" alt="YouTube Short">
