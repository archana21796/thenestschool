...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-107V014E5M"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'G-107V014E5M');
    </script>
    ...
    })(window,document,'script','dataLayer','GTM-KK8PMM9V');</script>
    <!-- End Google Tag Manager -->
   
    <title>IBDP & AS/A Level Admission</title>
    <meta charset="utf-8">
    <meta name="title" content="IBDP & AS/A Level Admission">
    <meta name="Description" content="Best Grade 11-12 School Chennai">
    ...
    fbq('init', '852933274253917');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=852933274253917&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KK8PMM9V"
     ...
     <section class="hero">
        <div class="hero__container">
            ...
            <div class="hero__content">
              ...
              <h3 class="subtitle">Architects of their Future</h3>
            
              <p class="programs">IB Diploma (IBDP) & Cambridge AS/A Levels</p>
    ...
    <section class="iim-banner-sec">
       <div class="desktop-banner">
            <a href="#" data-toggle="modal" data-target="#enquiry-for-admission"  data-button="banner" id="enquiry-for-admission-id" class="cta-item track-btn"><img loading="lazy" decoding="async" src="../assets/images/ibdp-as-a-level-bnr-new.webp" alt="nest-banner"></a>
        </div>
      
        <div class="mobile-banner">
            <img loading="lazy" decoding="async" src="../assets/images/ibdp-as-a-level-mbnr.webp" alt="nest-banner">
        </div>
        
          <div style="display:none">
            <h1>Admissions Open for Grade 11. Choose IB Diploma or Cambridge AS/A Levels. Expert University Guidance (MS-CDC) & Profile Building.</h1>
            <h2>IBDP & Cambridge AS/A Levels (Grade 11 & 12)</h2>
        </div>
    </section>-->
        ...
        <div class="grades-filter" >
            <div class="grades_filter_container">
                ...
                <ul class="grades_filter_menu" style="display: none;">
                    ...
                    <li data-grade-year="grade11-12" class="active"><span class="std">Grades 11-12</span><span class="split"> | </span><span class="abbr">IBDP/AS&A Levels</span></li>
                </ul>
            </div>
        </div>
    </section> 
            ...
            <div class="alumni-wrapper right">
                ...
                <div class="mobile-testi-btm-adjmt">
                 <div id="video-slider" class="owl-carousel owl-theme alumni-left-carousel logo-slider nest-event-slider testi-arrow">
                    <div class="event-image">
                      <a href="#lightbox" class="lightbox-toggle yt-thumb yt-popup" data-lightbox-type="video" data-lightbox-content="https://www.youtube.com/embed/XDGj9nAO5-0" rel="rel1">
                        <img src="../assets/images/gallery/NEST_IBDP_Web_Thumbnail.webp" alt="YouTube Short">
