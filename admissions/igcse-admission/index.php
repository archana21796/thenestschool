...
<head>
     <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-ZTR0L18WDR"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'G-ZTR0L18WDR');
    </script>
    ...
    })(window,document,'script','dataLayer','GTM-WQVPSK9K');</script>
    <!-- End Google Tag Manager -->

   <title>Cambridge IGCSE School Chennai</title>
    <meta charset="utf-8">
    <meta name="title" content="Cambridge IGCSE School Chennai">
    <meta name="Description" content="Grades 9-10 Admissions">
   ...
   <!-- Load Google reCAPTCHA API -->
    ...
    fbq('init', '2391281914654449');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=2391281914654449&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WQVPSK9K"
     ...
     <section class="hero">
        <div class="hero__container">
            ...
            <div class="hero__content">
              ...
              <h3 class="subtitle">The Bridge to Global Universities.</h3>
            
              <p class="programs">Cambridge IGCSE Board</p>
            
              <p class="admission">
                Admissions Open for Grades 9 & 10
              </p>
    ...
    <section class="iim-banner-sec">
        <div class="desktop-banner">
            <a href="#" data-toggle="modal" data-target="#enquiry-for-admission"  data-button="banner" id="enquiry-for-admission-id" class="cta-item track-btn"><img loading="lazy" decoding="async" src="../assets/images/igcse-admission-bnr-new.webp" alt="nest-banner"></a>
        </div>
      
        <div class="mobile-banner">
            <img loading="lazy" decoding="async" src="../assets/images/igcse-admission-mbnr.webp" alt="nest-banner">
        </div>
        
          <div style="display:none">
            <h1>Enroll for Cambridge IGCSE (9-10). Rigorous academic foundation with flexible subject choices. Bridge to A-Levels & University.</h1>
            <h2>Cambridge IGCSE Board (Grades 9 & 10)</h2>
        </div>
    </section> -->
        ...
        <div class="grades-filter" >
            <div class="grades_filter_container">
               ...
               <ul class="grades_filter_menu" style="display: none;">
                    <li data-grade-year="prekg" class=""><span class="std">Pre-KG to UKG</span><span class="split"> | </span><span class="abbr">IB EYP</span></li>
                    ...
                    <li data-grade-year="grade9-10" class="active"><span class="std">Grades 9-10</span><span class="split"> | </span><span class="abbr">IGCSE</span></li>
            ...
            <div class="alumni-wrapper right">
                ...
                <div class="mobile-testi-btm-adjmt">
                 <div id="video-slider" class="owl-carousel owl-theme alumni-left-carousel logo-slider nest-event-slider testi-arrow">
                    <div class="event-image">
                      <a href="#lightbox" class="lightbox-toggle yt-thumb yt-popup" data-lightbox-type="video" data-lightbox-content="https://www.youtube.com/embed/mSKoFm3HeqE" rel="rel1">
                        <img src="../assets/images/gallery/NEST_IGCSE_Web_Thumbnail.webp" alt="YouTube Short">
                ...
                <div class="modal-body">
                    <div class="form-style1" id="contact_form-grade1to5">
                        ...
                        <form id="form-enquiry-for-admission-grade1to5" method="post" action="contact-enquiry-for-admission" autocomplete="off" class="custom-form">
                            ...
                            <div id="recaptcha-form-enquiry-for-admission-grade1to5" class="g-recaptcha"></div><br><div id="recaptcha-form-campus" class="g-recaptcha"></div><br>
                            <label class="sub-btn" class="form-wrap">
                                <span id="loading-icon" class="loading-icon">  <img src="../assets/images/ajax-loader.gif" class="loader-img"></span>
                                <button type="submit" name="submit" class="submt-btn">Submit</button>
                            </label>
